    ...
    <Section id="features" className="bg-background py-24 relative overflow-hidden border-b border-border">
      <Container className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 min-h-[600px] lg:min-h-[500px]">
          ...
          {/* LEFT: FEATURE MENU */}
          <div className="lg:w-5/12 flex flex-col gap-3 -mx-4 px-4 sm:mx-0 sm:px-0 overflow-x-auto lg:overflow-x-visible pb-4 lg:pb-0 scrollbar-hide touch-pan-x overscroll-x-contain">
