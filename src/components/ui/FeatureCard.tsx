...
export function FeatureCard({
  ...
  return (
    <TiltCard className={cn("h-full", className)}>
      <div className="group bg-card hover:border-accent-400/40 hover:shadow-accent-950/40 relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-border p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        <div>
